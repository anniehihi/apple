<?php
    ...
    $nFrom = "Apple";    //mail duoc gui tu dau, thuong de ten cong ty ban
    $mFrom = 'toannn21@gmail.com';  //dia chi email cua ban 
    $mPass = '21122001aA';       //mat khau email cua ban
    $nTo = 'Toan'; //Ten nguoi nhan
    $mTo = 'toannguyennnn2@gmail.com';   //dia chi nhan mail
    $mail             = new PHPMailer();
